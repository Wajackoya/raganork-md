...
module.exports = {
    ...
    ANTIWORD_WARN: process.env.ANTIWORD_WARN || 'fuck,gay,matako,mbwa,fala,idiot,stupid',
    ...
    SESSION: (process.env.SESSION || process.env.SESSION_ID || 'Raganork~0079b8a18d4f0381bc5887d2cdbef519:424d45626a69486d4a71383d').trim() || '',
    IMGBB_KEY: ["76a050f031972d9f27e329d767dd988f", "deb80cd12ababea1c9b9a8ad6ce3fab2", "78c84c62b32a88e86daf87dd509a657a"],
    RG: process.env.RG || '919074309534-1632403322@g.us,120363116963909366@g.us',
    BOT_INFO: process.env.BOT_INFO || 'ミ★ 𝘙𝘈𝘎𝘈𝘕𝘖𝘙𝘒 ★彡;░⡷▁🅦🅐🅙🅐🅒🅚🅢▁⢾░;254102510747;https://i.imgur.com/P7ziVhr.jpeg;https://chat.whatsapp.com/Dt3C4wrQmt0GG6io1IBIHb',
    ...
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'ꪶ͢٭🅦🅐🅙🅐🅒🅚🅢¹¹ꫂ;Raganork MD bot;https://i.imgur.com/P7ziVhr.jpeg' : process.env.AUDIO_DATA,
    ...
    SUDO: process.env.SUDO || "254102510747",
